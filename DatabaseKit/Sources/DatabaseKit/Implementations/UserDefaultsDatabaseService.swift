...
public class UserDefaultsDatabase: DatabaseService {
    ...
    public func save<T: Codable>(_ object: T, forKey key: String) throws(DatabaseError) {
        do {
    ...
    public func get<T: Codable>(forKey key: String, as type: T.Type) throws(DatabaseError) -> T {
